...
# define byteAtPointer(ptr, self)			((sqInt)(*((unsigned char *)(ptr))))
# define byteAtPointerput(ptr,val, self)	((sqInt)(*((unsigned char *)(ptr))= (unsigned char)(val)))
# define shortAtPointer(ptr, self)		((sqInt)(*((short *)(ptr))))
# define shortAtPointerput(ptr,val, self)	((sqInt)(*((short *)(ptr))= (short)(val)))
# define intAtPointer(ptr, self)			((sqInt)(*((int *)(ptr))))
# define intAtPointerput(ptr,val, self)	((sqInt)(*((int *)(ptr))= (int)(val)))
# define longAtPointer(ptr, self)			(*(sqInt *)(ptr))
# define longAtPointerput(ptr,val, self)	(*(sqInt *)(ptr)= (sqInt)(val))
# define long64AtPointer(ptr, self)			(*(sqLong *)(ptr))
# define long64AtPointerput(ptr,val, self)	(*(sqLong *)(ptr)= (sqLong)(val))
# define singleFloatAtPointer(ptr, self)		(*(float*)(ptr))
# define singleFloatAtPointerput(ptr, val, self)		(*(float*)(ptr) = val)
# define floatAtPointer(ptr, self)		        (*(double*)(ptr))
# define floatAtPointerput(ptr, val, self)		(*(double*)(ptr) = val)
# define pointerAtPointer(ptr, self)		        (*(char**)(ptr))
# define pointerAtPointerput(ptr, val, self)		(*(char**)(ptr) = val)
# define oopAtPointer(ptr, self)			(*(sqInt *)(ptr))
# define oopAtPointerput(ptr,val, self)	(*(sqInt *)(ptr)= (sqInt)(val))
# if defined(sqMemoryBase) && !sqMemoryBase
#  define pointerForOop(oop, self)		((char *)(oop))
#  define oopForPointer(ptr, self)		((sqInt)(ptr))
#  define atPointerArg(oop, self)			oop
# else
...
# endif
# define byteAt(oop, self)				byteAtPointer(atPointerArg(oop, self), self)
# define byteAtput(oop,val, self)			byteAtPointerput(atPointerArg(oop, self), val, self)
# define shortAt(oop, self)				shortAtPointer(atPointerArg(oop, self), self)
# define shortAtput(oop,val, self)		shortAtPointerput(atPointerArg(oop, self), val, self)
# define longAt(oop, self)				longAtPointer(atPointerArg(oop, self), self)
# define longAtput(oop,val, self)			longAtPointerput(atPointerArg(oop, self), val, self)
# define long64At(oop, self)				long64AtPointer(atPointerArg(oop, self), self)
# define long64Atput(oop,val, self)		long64AtPointerput(atPointerArg(oop, self), val, self)
# define intAt(oop, self)					intAtPointer(atPointerArg(oop, self), self)
# define intAtput(oop,val, self)			intAtPointerput(atPointerArg(oop, self), val, self)
# define oopAt(oop, self)					oopAtPointer(atPointerArg(oop, self), self)
# define oopAtput(oop,val, self)			oopAtPointerput(atPointerArg(oop, self), val, self)

# define int8AtPointer(ptr, self)          (*(signed char*)(ptr))
# define int8AtPointerput(ptr, val, self)  (*(signed char*)(ptr) = val)
# define uint8AtPointer(ptr, self)          (*(unsigned char*)(ptr))
# define uint8AtPointerput(ptr, val, self)  (*(unsigned char*)(ptr) = val)

# define int16AtPointer(ptr, self)          (*(signed short*)(ptr))
# define int16AtPointerput(ptr, val, self)  (*(signed short*)(ptr) = val)
# define uint16AtPointer(ptr, self)          (*(unsigned short*)(ptr))
# define uint16AtPointerput(ptr, val, self)  (*(unsigned short*)(ptr) = val)

# define int32AtPointer(ptr, self)          (*(signed int*)(ptr))
# define int32AtPointerput(ptr, val, self)  (*(signed int*)(ptr) = val)
# define uint32AtPointer(ptr, self)          (*(unsigned int*)(ptr))
# define uint32AtPointerput(ptr, val, self)  (*(unsigned int*)(ptr) = val)

# define int64AtPointer(ptr, self)          (*(sqLong*)(ptr))
# define int64AtPointerput(ptr, val, self)  (*(sqLong*)(ptr) = val)
# define uint64AtPointer(ptr, self)          (*(usqLong*)(ptr))
# define uint64AtPointerput(ptr, val, self)  (*(usqLong*)(ptr) = val)
