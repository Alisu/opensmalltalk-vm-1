...
static sqInt (*makePointwithxValueyValue)(sqInt xValue, sqInt yValue, struct foo * self);
...
extern sqInt makePointwithxValueyValue(sqInt xValue, sqInt yValue, struct foo * self);
